...
class FacultyProfileCollection extends BaseProfileCollection {
   ...
   * @param emergencyEmail The emergency phone email.
   */
   ...
   * @param emergencyPhone new emergency num (optional).
   * @param emergencyEmail new emergency email (optional).
   */
  ...
  dumpOne(docID) {
    ...
    const emergencyPhone = doc.emergencyPhone;
    const emergencyEmail = doc.emergencyEmail;
    return { email, firstName, lastName, position, picture, emergencyPhone, emergencyEmail }; // CAM this is
    // not enough

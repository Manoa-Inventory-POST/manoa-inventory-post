...
/*  something to do with rooms collections here */
  ...
  <Card className="rounded-0">
    ...
    <Card>
      <Card.Body>
        <Card.Img src="https://cdn.shopify.com/s/files/1/0533/2089/files/placeholder-images-image_large.png?format=jpg&quality=90&v=1530129081" className="shadow-4 float-start m-4" alt="" style={{width: "150px"}} />
